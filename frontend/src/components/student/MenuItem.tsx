    ...
    <>
      ...
      <div
        ...
        style={{
          ...
          border: `1px solid ${hovered ? 'rgba(255, 90, 95,0.45)' : 'rgba(255,255,255,0.08)'}`,
          borderRadius: '16px',
          overflow: 'hidden',
          position: 'relative',
          ...
          boxShadow: hovered
            ? '0 16px 48px rgba(255, 90, 95,0.18), 0 4px 16px rgba(0,0,0,0.4), inset 0 0 0 1px rgba(255, 90, 95,0.08)'
      ...
      >
        ...
        <div style={{
          ...
          borderRadius: '4px',
          border: `2px solid ${item.is_vegetarian ? '#ff5a5f' : '#ff3366'}`,
          ...
          <div style={{
            ...
            borderRadius: '50%',
            background: item.is_vegetarian ? '#ff5a5f' : '#ff3366',
          }} />
        </div>
        ...
        <div className="menu-item-img" style={{
          ...
          {item.image_url ? (
            ...
            <div style={{
              ...
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: '3.5rem',
              background: 'linear-gradient(135deg, rgba(255, 90, 95,0.05), rgba(255, 158, 61,0.05))',
            }}>
              🍽️
            </div>
          )}
          ...
          <div style={{ marginTop: '4px' }}>
            {cartQuantity > 0 && isAvailable ? (
              ...
              <div style={{
                ...
                border: `1px solid ${atStockLimit ? 'rgba(255,237,78,0.5)' : 'rgba(255, 90, 95,0.35)'}`,
                borderRadius: '10px',
                overflow: 'hidden',
              }}>
                ...
                <button
                  ...
                  onMouseEnter={(e) => {
                    if (!atStockLimit) e.currentTarget.style.background = 'rgba(255, 90, 95,0.12)';
                  }}
                  onMouseLeave={(e) => (e.currentTarget.style.background = 'transparent')}
                >
                  +
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  if (isAvailable) {
                    e.currentTarget.style.background = 'rgba(255, 90, 95,0.14)';
                    e.currentTarget.style.boxShadow = '0 0 14px rgba(255, 90, 95,0.25)';
                  }
                }}
                onMouseLeave={(e) => {
