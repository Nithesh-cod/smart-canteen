...
@keyframes points-pulse {
  0%, 100% { box-shadow: 0 0 8px rgba(255, 90, 95,0.3); }
  50% { box-shadow: 0 0 20px rgba(255, 90, 95,0.6), 0 0 35px rgba(255, 90, 95,0.2); }
}
@keyframes avatar-glow {
  0%, 100% { box-shadow: 0 0 12px rgba(255, 90, 95,0.4); }
  50% { box-shadow: 0 0 22px rgba(255, 158, 61,0.5); }
}
`;
